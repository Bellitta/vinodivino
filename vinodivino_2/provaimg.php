   ...
   ?>
	 ...
	 <?php
        ...
        while ($riga = $risultato->fetch_array()) {
          ...
          echo "<h5><a href='dettaglio_ordini.php?id=$id_prodotto'>$nome - $produttore</a></h5>";
          echo "<p>$descrizione";
          echo " <span class='badge badge-success'>EUR $prezzo</span>";
          echo "<a href='aggiungicarrello.php?id=$id_prodotto'><span class='glyphicon glyphicon-shopping-cart' aria-hidden='true'></span></a>";
          echo "</p>";
          echo "</article>";
          echo "</div>";
